...
export default function CTA() {
    return (
        <section className="py-24 relative overflow-hidden">
            {/* Dynamic Background */}
            <div className="absolute inset-0 bg-gradient-to-br from-brand-blue to-brand-dark z-0"></div>
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                    <Link href="/demo">
                        <Button size="lg" className="bg-white text-brand-blue hover:bg-gray-100 shadow-lg text-lg px-10 w-full sm:w-auto">
                            预约专属演示
                        </Button>
                    </Link>
