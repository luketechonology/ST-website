        ...
        <section className="py-20 bg-black/50 border-y border-white/5">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <div className="w-20 h-1 bg-brand-red mx-auto rounded"></div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    {points.map((point, index) => (
                        <div key={index} className="bg-brand-dark border border-white/10 p-8 rounded-xl text-center hover:border-brand-red/50 transition-colors group">
                ...
                <div className="text-center mt-12">
                    <p className="text-brand-gold text-lg font-medium">AI不是工具升级，而是考试体系重构。</p>
                </div>
            </div>
        </section>
    );
